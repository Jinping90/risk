package com.wjl.fcity.park.common.util;
...
//    }
     ...
     * @return
     */
    public static String getRandomStr(int length, boolean numberFlag) {
        String retStr = "";
     ...
     * @return
     */
    public static String filterIllegalChar(String text) {
     ...
     * @return
     */
    public static String truncStringByByteLength(String str, int maxLength){
		...
		for(int i=0; i<d.length; i++) {
			String temp = String.valueOf(d[i]);
